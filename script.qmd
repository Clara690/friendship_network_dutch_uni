...
tribble(
  ~'' , ~Time_1, ~Time_4,
  I("in degree (μ)"), avg_in_degree_t1, avg_in_degree_t4,
  I("in degree (α)"), sd_ind_t1, sd_ind_t4,
  I("out degree (μ)"), avg_out_degree_t1, avg_out_degree_t4,
  I("out degree (α)"), sd_outd_t1, sd_outd_t4,
  "density", d_t1, d_t4,
...
hist(shortest_path_lengths_t1, 
     main = I("Histogram of Shortest Path Lengths \n 
              at Time 1 -in degree"), 
